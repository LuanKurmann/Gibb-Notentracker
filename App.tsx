...
import { SchoolConfig, Grade, ComingGrade, Settings as AppSettings } from './types';
...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-200 pb-safe">
      {/* Top Navigation */}
      <header className="sticky top-0 z-30 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border-b border-gray-100 dark:border-gray-800 px-4 py-3 sm:py-4">
               ...
               {upcomingExams.length > 0 ? (
                  <div className="space-y-3">
                     {upcomingExams.slice(0, 3).map(ex => {
                         ...
                         return (
                             <div key={ex.id} className="bg-white dark:bg-gray-700/50 p-3 rounded-xl flex items-center justify-between shadow-sm">
                                 <div>
